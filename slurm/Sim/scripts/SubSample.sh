...
############ executables
export EXE_NAME=subsample # name of the executable
...
############ arguments
USAGE="Usage: ./Rotate.sh <input dir> <output dir> <name>"
if [ $# -ne 3 ]; then
    echo $USAGE
    exit 1
fi
...
rm -rf $JOB_PATH/subsample_${NAME}*
rm -rf $LOG_PATH/subsample_${NAME}*
...
FILENAME=${JOB_PATH}/subsample_${NAME}.sh
JOBNAME=subsample_${NAME}
