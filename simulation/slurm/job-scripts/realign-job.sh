#!/bin/bash
#SBATCH -J realign			       #The name of the job
...
#SBATCH --error=/lustre/isaac/scratch/tmengel/jet-vn-cumulant/simulation/slurm/slurm-err/realign.e%J	     
#SBATCH --output=/lustre/isaac/scratch/tmengel/jet-vn-cumulant/simulation/slurm/slurm-out/realign.o%J	     
#SBATCH --qos=condo
