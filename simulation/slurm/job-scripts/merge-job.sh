#!/bin/bash
#SBATCH -J merge			       #The name of the job
...
#SBATCH --error=/lustre/isaac/scratch/tmengel/jet-vn-cumulant/simulation/slurm/slurm-err/merge.e%J	     
#SBATCH --output=/lustre/isaac/scratch/tmengel/jet-vn-cumulant/simulation/slurm/slurm-out/merge.o%J	     
#SBATCH --qos=condo
